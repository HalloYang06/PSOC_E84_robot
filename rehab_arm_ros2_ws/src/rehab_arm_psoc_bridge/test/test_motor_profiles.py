...
class MotorProfilesTests(unittest.TestCase):
    def test_profiles_capture_current_bench_motor_identity(self) -> None:
        ...
        self.assertEqual(MOTOR_PROFILES[3]['mechanical_reduction_ratio'], 48.0)
        ...
        self.assertEqual(MOTOR_PROFILES[4]['mechanical_reduction_ratio'], 10.0)
        ...
        self.assertEqual(MOTOR_PROFILES[5]['mechanical_reduction_ratio'], 10.0)
        ...
        self.assertEqual(MOTOR_PROFILES[6]['mechanical_reduction_ratio'], 9.0)
        ...
        self.assertEqual(MOTOR_PROFILES[7]['mechanical_reduction_ratio'], 9.0)
