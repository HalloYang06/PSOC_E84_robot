...
class SystemArchitectureContractTests(unittest.TestCase):
    ...
    def test_voice_and_rehab_session_contracts_are_dry_run_only(self) -> None:
        ...
        self.assertIn('check_operator_review', setup)
        ...
        self.assertIn('check_operator_review.py', cmake)
    ...
    def test_sim_host_user_qa_script_is_readonly_and_reusable(self) -> None:
        ...
        self.assertIn('check_operator_review.py', script)
        ...
        self.assertIn('operator_review_quality_report_v1', script)
