    ...
    return ok(
        {
            ...
            "downloads": {
                ...
                "debug_apk_version": "1.0.12",
                "debug_apk_sha256": "E189C4A7A92CEEEF44D2F7390457B3E290B4A62794983C4EFA49DEF7654B2059",
            ...
            "release_gate": {
                ...
                "checks": [
                    ...
                    },
                    {
                        ...
                        "description": "APK 1.0.12 includes a Capacitor/Android Bluetooth Classic SPP bridge plus a Stitch-designed Bluetooth debug page for listing paired devices, binding one as a backend trusted device, connecting SPP, sending backend-approved legacy frames, and uploading inbound ACK/sensor evidence. User release still needs physical validation with current M33 firmware.",
                    },
                ],
