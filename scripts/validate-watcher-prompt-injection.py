...
def main() -> int:
    ...
    results.append(_check("提到真实 project_id 的项目知识库路径", "docs/projects/proj_ai_collab/README.md" in md))
    ...
    results.append(_check("prompt 提到真实 project_id 的项目级背景", "docs/projects/proj_ai_collab/README.md" in prompt))
