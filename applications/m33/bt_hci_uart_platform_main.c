...
static bool g_bt_post_stack_init_seen = false;
...
*/
bool bt_post_stack_init_seen(void)
{
    return g_bt_post_stack_init_seen;
}
...
void wiced_post_stack_init_cback( void )
{
    ...
    g_bt_post_stack_init_seen = true;
                                          ...
                                          )
{
    ...
    cybt_main_cb.is_sleep_mode_enabled = false;
    g_bt_post_stack_init_seen = false;
