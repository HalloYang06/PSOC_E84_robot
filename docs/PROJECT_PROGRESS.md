...
- Board QA now proves upstream audio reaches cloud ASR: `m33qa_xz_probe` publishes four shared PCM chunks, `m55qa_status` shows `xz_last=193/370560` or similar, and M33 prints ASR text such as `不知道。`.
