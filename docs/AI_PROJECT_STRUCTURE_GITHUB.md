...
5. `docs/项目进展.md` for latest state
...
| Path | Update when |
|---|---|
| `docs/项目进展.md` | Any meaningful task changes state, validates hardware/software, adds docs, changes architecture, or discovers a blocker |
...
| `docs/用户手册.md` | User-facing commands, workflows, setup, safety notes, validation steps, or expected outputs change |
...
| `rehab-arm-progress-keeper` | Keeping `项目进展.md` and `TROUBLESHOOTING_AND_LESSONS.md` current |
...
| Path | Purpose |
|---|---|
| `docs/项目进展.md` | Latest task history and validation state |
| `docs/TROUBLESHOOTING_AND_LESSONS.md` | Pitfalls, root causes, fixes, reusable lessons |
| `docs/用户手册.md` | User-facing workflows and commands |
