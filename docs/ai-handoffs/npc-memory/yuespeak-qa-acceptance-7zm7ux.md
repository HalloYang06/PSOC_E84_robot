# NPC Knowledge Base: YueSpeak QA Acceptance

Project id: 5aa74456-438f-4d75-9899-415cb04c4acf
NPC role: Own acceptance criteria, browser validation, data-loop checks, compliance checkpoints, and screenshot reports. Only verify Codex-thread work.
...
- Required capabilities: repo-bootstrap, thread-adapter
- References: none
