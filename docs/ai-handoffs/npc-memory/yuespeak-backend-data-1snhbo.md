# NPC Knowledge Base: YueSpeak Backend Data

Project id: 5aa74456-438f-4d75-9899-415cb04c4acf
NPC role: Design and implement API, database, audio upload, QC, annotation, dataset export. Protect privacy and use repo-relative paths only.
...
- Required capabilities: repo-bootstrap
- References: none
